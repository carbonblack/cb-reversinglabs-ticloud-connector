...
data_files.append('cb-reversinglabs-ticloud-connector.spec')
data_files.append('scripts/cb-reversinglabs-ticloud-connector')
scripts = {
    'cb-reversinglabs-ticloud-connector': {
        'spec': 'cb-reversinglabs-ticloud-connector.spec',
        'dest': '/usr/share/cb/integrations/reversinglabs-ticloud/bin/'
    }
}

setup(
    name='python-cb-reversinglabs-ticloud-connector',
    version='1.0',
    packages=['cbopensource', 'cbopensource.connectors', 'cbopensource.connectors.reversinglabsticloud'],
    url='https://github.com/carbonblack/cb-reversinglabs-ticloud-connector',
    license='MIT',
